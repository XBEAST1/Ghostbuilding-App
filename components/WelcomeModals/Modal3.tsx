...
const Modal3: React.FC<Modal3Props> = ({ onNext, onPrev, onClose }) => {
      ...
      <DialogContent className="w-[95%] max-w-lg sm:max-w-xl bg-[#151A22] border border-[#4D4D4D] text-white rounded-lg pt-16 pb-16 sm:pt-20 sm:pb-20 px-4 sm:px-8">
          ...
          {[
            {
              ...
              icon: (
                <LaptopIcon className="text-white w-8 h-8 sm:w-10 sm:h-10 mb-3 sm:mb-4" />
              ),
            },
            {
            ...
            },
            {
              ...
              icon: (
                <ShopIcon className="text-white w-8 h-8 sm:w-10 sm:h-10 mb-3 sm:mb-4" />
              ),
            },
            {
              label: "Mid-Size Company",
              icon: (
                <BuildingIcon className="text-white w-8 h-8 sm:w-10 sm:h-10 mb-3 sm:mb-4" />
              ),
            },
            {
            ...
            },
            {
              ...
              icon: (
                <StarIcon className="text-white w-8 h-8 sm:w-10 sm:h-10 mb-3 sm:mb-4" />
              ),
            },
          ].map((card, i) => (
            <div
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-6 items-center mt-12 sm:mt-20 w-full px-2 sm:px-6">
          ...
          <div className="flex items-center gap-4 w-full">
            ...
            <span className="text-sm whitespace-nowrap">2/5</span>
          </div>
